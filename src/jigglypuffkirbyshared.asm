...
scope JigglypuffKirbyShared {
    ...
    scope jump_fix_2: {
        ...
        beq     v0, at, _op_puff_jump_2            // modified original line 2
        addiu   at, r0, Character.id.DEDEDE     // Dedede ID
        ...
        lui     at, puff_jump_decay         // at - Puffs jump decay
        mtc1    at, f8                      // move at to float
        cvt.s.w f6, f4                      // convert f6
        li      at, op_puff_jump_multiplier_table // at = jump multipler table
